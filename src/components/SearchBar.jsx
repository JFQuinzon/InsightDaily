    ...
    <div className="w-full">
      <form onSubmit={handleSubmit}>
        ...
        <div className="relative">
          ...
          <button
            type="submit"
            className="text-white absolute right-2.5 bottom-1.5 bg-black hover:bg-gray-800 focus:ring-1 focus:outline-none focus:ring-gray-800 font-medium rounded-lg text-sm px-4 py-2"
          >
            Search
          </button>
        </div>
