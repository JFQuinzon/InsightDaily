...
const errorMessages = {
  ...
  PasswordRequiresNonAlphanumeric: "Password must include a special character.",
  PasswordRequiresDigit: "Password must include a number.",
  PasswordRequiresUpper: "Password must include an uppercase letter.",
};
...
function Register() {
  ...
  const { success, errors, loading, register } = useRegister();
                ...
                {errors.length > 0 && (
                  <div className="text-red-500">
                    {errors.map((error, index) => {
                      ...
                      return <p key={index}>{customMessage}</p>;
                    })}
                  </div>
                )}
                {!loading && (
